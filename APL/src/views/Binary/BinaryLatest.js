...
export default function BinaryLatest() {
  ...
  const [downloadInProgress, setDownloadInProgress] = useState(false);
	...
	console.log(params.binData);
	//var myData = {name: "APL", type: "APK", version: "LATEST" };
	//console.log(encodeURIComponent(JSON.stringify(myData)));
...
function downloadLatest() {
  ...
  return (
    <Container component="main" maxWidth="xs">
      <CssBaseline />
      <div align="center">
        <h3>{`Download Latest ${currRecord.type} of ${currRecord.name}`}</h3>
        <BinaryInfo />
        <DownLoadLatest />
        <ShowResisterStatus/>
      </div>
